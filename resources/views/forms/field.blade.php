	...
	<div>
		...
		{!! Form::select('field[][type]',$types['field'], "",['class' => 'form-control select-sm','id' => 'fieldType', 'style'=>"width: 10em"]) !!}
			<div class="options" style="">
				...
				<div class="optsBoolean" style="clear: both; margin-left: 2em;">
					<div>
						{!! Form::label('txtFalse', 'False Option', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::text('field[][opts][boolean][false]',"No",['class' => 'form-control input-sm','id'=>'txtFalse', 'style'=>"width: 10em !important", 'maxlength'=>""]) !!}
					</div>
					<div>
						{!! Form::label('txtTrue', 'True Option', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::text('field[][opts][boolean][true]',"Yes",['class' => 'form-control input-sm','id'=>'txtTrue', 'style'=>"width: 10em !important", 'maxlength'=>""]) !!}
					</div>
					<div>
						{!! Form::label('selTypeBool', 'Type', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::select('field[][opts][boolean][type]',$types['boolean'], "",['class' => 'form-control select-sm','id' => 'selTypeBool', 'style'=>"width: 10em"]) !!}
					</div>
				</div>
				<div class="optsChoice" style="clear: both; margin-left: 2em;">
					<div style="clear: both;">
						{!! Form::label('chkMultichoice', 'Multiple', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::checkbox('field[][opts][choice][multi]',1, false,['id'=>'chkMultichoice', 'style'=>"opacity: 1"]) !!}
					</div>
					<div style="clear: both;">
						<div id="optsChoices">
				...
				<div class="optsCurrency" style="clear: both; margin-left: 2em;">
					&nbsp;
				</div>
				<div class="optsDatetime" style="clear: both; margin-left: 2em;">
					<div>
						{!! Form::label('chkDateTimeSubA', 'Date & Time', array('class' => 'col-md-5 control-label', 'style'=>"clear: both; float: left;")) !!}
					...
					<div>
						{!! Form::label('chkDateTimeSubB', 'Date Only', array('class' => 'col-md-5 control-label', 'style'=>"clear: both; float: left; ")) !!}
						<div class="" style="padding-top: 7px;">
					...
					<div>
						{!! Form::label('chkDateTimeSubC', 'Time Only', array('class' => 'col-md-5 control-label', 'style'=>"clear: both; float: left; ")) !!}
						<div class="" style="padding-top: 7px;">
				...
				<div class="optsFile" style="clear: both; margin-left: 2em;">
				&nbsp;	
				</div>
				<div class="optsNumber" style="clear: both; margin-left: 2em;">
					<div>
						{!! Form::label('txtDecimals', 'Decimals', array('class' => 'col-md-3 control-label')) !!}
						<div class="col-md-3">
					...
					<div>
						{!! Form::label('txtMin', 'Min', array('class' => 'col-md-3 control-label', 'style'=>"clear: both")) !!}
						<div class="col-md-3">
						{!! Form::text('field[][opts][number][min]',"0",['class' => 'form-control input-sm','id'=>'txtMin', 'style'=>"width: 5em !important", 'maxlength'=>"-1"]) !!}
						</div>
					</div>
					<div>
						{!! Form::label('txtMax', 'Max', array('class' => 'col-md-3 control-label', 'style'=>"clear: both")) !!}
						<div class="col-md-3">
						{!! Form::text('field[][opts][number][max]',"0",['class' => 'form-control input-sm','id'=>'txtMax', 'style'=>"width: 5em !important", 'maxlength'=>"-1"]) !!}
						</div>
					</div>
				</div>
				<div class="optsText" style="clear: both; margin-left: 2em;">
					<div>
						{!! Form::label('txtLines', 'Lines', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::text('field[][opts][text][lines]',"1",['class' => 'form-control input-sm','id'=>'txtLines', 'style'=>"width: 4em !important", 'maxlength'=>"3"]) !!}
					</div>
					<div>
						{!! Form::label('txtMinLen', 'Min', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::text('field[][opts][text][min]',"1",['class' => 'form-control input-sm','id'=>'txtMinLen', 'style'=>"width: 4em !important", 'maxlength'=>"3"]) !!}
					</div>
					<div>
						{!! Form::label('txtMaxLen', 'Max', array('class' => 'col-md-5 control-label')) !!}
						{!! Form::text('field[][opts][text][min]',"255",['class' => 'form-control input-sm','id'=>'txtMaxLen', 'style'=>"width: 5em !important", 'maxlength'=>"5"]) !!}
					</div>
				</div>
				<br>
				<br>
